...
const Variants = {
  color: `
    ...
    --button-bg-color: var(--barogo-color-1);
  `,
  color2: `
  --button-color: var(--barogo-color-1);
  --button-bg-color: var(--barogo-color-3);
  `,
  gray: `
  ...
  `,
  border: `
    --button-border-color: var(--barogo-color-1);
  ...
  darkgray: `
  --button-color: var(--white-color-1);
  --button-bg-color: var(--gray-color-7);
  `,
};
